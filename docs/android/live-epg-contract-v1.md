...
1. Pin supported response variants and timezone/base64 behavior to safe, redacted provider fixtures before accepting a production parser; the request action and parameter shape already have two independent client references.
