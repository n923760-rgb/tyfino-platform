...
jq -e '
 ...
 (.required_fixtures | sort == ["clean_repository","dirty_worktree","missing_evidence","resource_failure","unauthorized_action","wrong_official_head"])
' governance/governance-qualification.json >/dev/null || fail "Invalid Phase 6 manifest"
...
printf '[governance-qualification] PASS: Phase 6 structure and adversarial suite are valid.\n'
